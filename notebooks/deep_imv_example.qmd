...
product_loss, var_losses, loss = joint_model.loss(example_target, yhat, poe_dist, yhats, dists)
loss.backward()
```
...
for i in range(1500):
    ...
    # product_loss, var_losses, loss = joint_vae.loss(y_gt, yhat, poe_dist, yhats, dists, var_beta = 0.01)
...
for i in range(2000):
    ...
    # pass the predictions and distributions to the loss function and update parameters
    product_loss, var_losses, loss = joint_vae.loss(y_gt, yhat, poe_dist, yhats, dists)
...
lip_int_scores, metab_int_scores, pro_int_scores = integrated_grads(
    ...
    joint_vae, n_steps = 100, class_idx = 1
)
```
...
tcgadata = np.load('~/Documents/Data/tcga/multi_omics_1yr_mortality.npz')
```
...
for epoch in range(40):
    ...
    for idx, batch in enumerate(train_loader):
        ...
        for comb, x in input_dict.items():
            ...
            product_loss, var_losses, tmp_loss = joint_model.loss(y_gt, yhat, poe_dist, yhats, dists, alpha = alpha, gamma = gamma)
            loss += tmp_loss
