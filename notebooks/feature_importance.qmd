...
```{python}
joint_model.load_state_dict(torch.load('joint_model_nb.pt'))
```
...
```{python}
proteins_igrad_out.to_csv("/Users/clab683/git_repos/DeepIMV/output/igrads-notebook-proteins-rangefix-2024-01-31.csv", index=False)
```
